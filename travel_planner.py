...
configure(api_key="AIzaSyABsQoAjI8As9e3HqnM0JGTbnYmQNHCuhA")
gemini_model = GenerativeModel("gemini-2.0-flash")

class PlannerState(TypedDict):
    messages: Annotated[TypingList[str], "the messages in the conversation"]
    interests: TypingList[str]
    days: int
    itinerary: str

def generate_itinerary(city: str, interests: TypingList[str], days: int) -> str:
